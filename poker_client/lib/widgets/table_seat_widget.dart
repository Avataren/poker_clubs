      ...
      child: SizedBox(
        ...
        child: Stack(
          ...
          children: [
            ...
            // Remove bot button (cash games only) - positioned at lower right of nameplate
            // Rendered LAST to be on top of other elements
            if (player!.isBot && !isTournament && onRemoveBot != null)
              Positioned(
                top: namePlateTop + (avatarSize * 0.55), // Lower part of nameplate
                left: (frameWidth / 2) + (seatSize * 0.525), // Right edge of nameplate
                child: Material(
